...
.venv/bin/pytest -q          # 319 tests (315 passed + 3 skipped opt-in + 1 documented xfail), ~55s (real Docker containers) — never makes a real LLM/network-to-a-provider call
.venv/bin/ai-os …            # opt-in heavy tests: AI_OS_TEST_JAVA_SANDBOX=1 (Maven), AI_OS_TEST_DB_SANDBOX=1 (Postgres sidecar)
